...
var WorkspaceSwitcherPopup2 = new Lang.Class({
    Name: 'WorkspaceSwitcherPopup2',
...
Signals.addSignalMethods(WorkspaceSwitcherPopup2.prototype);




function init() {
    oldPrototype = WorkspaceSwitcherPopup.WorkspaceSwitcherPopup.prototype;
}

function enable() {
    WorkspaceSwitcherPopup.WorkspaceSwitcherPopup.prototype = WorkspaceSwitcherPopup2.prototype;
}

function disable() {
    WorkspaceSwitcherPopup.WorkspaceSwitcherPopup.prototype = oldPrototype;
}
